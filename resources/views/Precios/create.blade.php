        ...
        <div class="col-md-8 offset-md-2">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="fas fa-plus-circle me-2"></i>Crear Nuevo Precio</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('precios.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('id_detalleproducto') is-invalid @enderror" 
                                ...
                                @foreach($detallesProductos as $detalle)
                                    <option value="{{ $detalle->id }}" {{ old('id_detalleproducto') == $detalle->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="tipo" name="tipo" 
                                   value="{{ old('tipo') }}" maxlength="50" placeholder="Ej: Normal, Promoción">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="cantidadminima" name="cantidadminima" 
                                       value="{{ old('cantidadminima') }}" min="0" placeholder="0">
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('cantidadmaxima') is-invalid @enderror" 
                                       ...
                                       value="{{ old('cantidadmaxima') }}" min="0" placeholder="0">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('precioVenta') is-invalid @enderror" 
                                   id="precioVenta" name="precioVenta" value="{{ old('precioVenta') }}" 
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('tipo_cliente') is-invalid @enderror" 
                                ...
                                <option value="distribuidor" {{ old('tipo_cliente') == 'distribuidor' ? 'selected' : '' }}>Distribuidor</option>
                            </select>
                            @error('tipo_cliente')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
