...
<div class="container-fluid mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1><i class="fas fa-money-bill-wave me-2"></i> Reporte 2: Productos que Más Dinero Generan</h1>
    ...
    @if(request()->has('fecha_inicio'))
        ...
        <div class="card">
            <div class="card-header bg-primary text-white"><h5 class="mb-0">Top Productos por Ingresos</h5></div>
        ...
        <tr>
            ...
            <td class="text-end">
                <span class="badge bg-success">
                    {{ $total > 0 ? round(($item['total'] / $total) * 100, 2) : 0 }}%
                </span>
            </td>
        </tr>
    @empty
