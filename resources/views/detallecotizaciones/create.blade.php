...
<head>
  <meta charset="utf-8">
  <title>Nuevo Detalle de Cotización</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body class="p-4">

<div class="container">
  <h1 class="mb-4">Registrar Detalle de Cotización</h1>
  ...
  <form action="{{ route('detallecotizaciones.store') }}" method="POST">
    @csrf
    ...
    <a href="{{ route('detallecotizaciones.index') }}" class="btn btn-secondary">Volver</a>
  </form>
</div>
</body>
</html>
